...
try:
    ...
    d3.sendCommand('camera.enable', { 'template': 'v4l2' });
    ...
    while True:
        ...
        if packet != None:
            ...
            elif event == 'DRFloorDepth.enable':
                print("Floor depth enabled")
            elif event == 'DRFrontDepth.enable':
                print("Front depth enabled")
